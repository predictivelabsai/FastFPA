...
PRODUCT = 'FastFPA'
BASE_URL = 'https://fpa.fastsme.com'
DESCRIPTION = 'Connect actuals, drivers, budgets, forecasts, scenarios, and performance reviews in one governed planning workspace.'
KEYWORDS = ('FastFPA', 'open source financial planning & analysis', 'financial planning & analysis software', 'SME financial planning & analysis', 'Driver-based budgets and forecasts', 'Scenarios and variance analysis', 'Approvals lineage and management reporting', 'FastSME', 'open source business software')
FEATURES = ('Driver-based budgets and forecasts', 'Scenarios and variance analysis', 'Approvals lineage and management reporting')
